...
export default class UI {
  static initialiseButtons() {
    ...
    const cancelAddProjectButton = document.getElementById(
      "cancelAddProjectBtn"
    );
    ...
    createProjectButton.addEventListener(
      "click",
      Coordinator.handleCreateProjectButton
    );
  ...
  static initialiseContextButtons(target) {
    ...
    deleteButton.addEventListener("click", () =>
      Coordinator.deleteTaskOrProject(target)
    );
  }
  ...
  static resetTaskInputs(projectName) {
    ...
    if (
      projectName == "Today's Tasks" ||
      projectName == "Week's Tasks" ||
      projectName == "Done"
    ) {
  ...
  static createDeleteButton(task) {
    ...
    deleteBtn.addEventListener("click", (e) => {
      const taskName = e.target.parentNode.parentNode.querySelector("p")
        .textContent;
